<template>
    <div class="fixed z-10 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        <div class="flex items-end justify-center min-h-screen h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <!-- Body -->
            <div class="inline-block h-5/6 align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:w-full max-w-7xl">
                            ...
                            <div class="flex flex-col h-0 flex-1 border-r border-gray-200 bg-gray-100">
                                <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                                    ...
                                    <div class="flex-shrink-0 px-4 flex items-center">
                                        <h2 class="h-8 w-auto font-bold text-xl">Edit Comic</h2>
                                    </div>
                                    ...
                                    <div class="px-4 sm:px-6 h-full md:px-0">
                                        <div class="space-y-6 sm:px-6 h-full lg:px-0 lg:col-span-9">
                                            <div v-if="isDetails" class="relative h-full">
                                                <DetailsModal @closeEditModal="closeEditModal()" :comic="comic"></DetailsModal>
                                            </div>
...
import IssuesModal from '../Components/IssuesModal.vue';
    ...
    data() {
        return {
            navigationItems: [
                ...
                { id: 2, name: 'Issues', icon: UserCircleIcon, current: this.isIssues},
            ],
        }
    },
    methods: {
